...
class ProdukController extends Controller
{
    public function index(){
        $data['data'] = MasterProduk::with('master_kategori', 'master_subkategori')->orderby('id','desc')->get();
    ...
    public function datatables(){
        $data = MasterProduk::with('master_kategori', 'master_subkategori', 'master_seller')->orderby('id','desc')->get();
        ...
        return DataTables::of($data)
                    ...
                    ->addColumn('produk_image', function($data) {
                        // if(str_contains($data->url_image[0], 'api-kharisma.s3')) {
    ...
    public function store_update(request $request){
		...
		try{
            ...
            $request->request->add(['nama_produk_slug' => Str::slug($request->nama_produk, '-') ]);
				...
				try {
					foreach ($arr as $item) {
                        $master_produk = MasterProduk::updateOrCreate([
                            ...
                            'nama_produk_slug' => Str::slug($item['nama_produk'], '-'),
