...
Route::get('auth/google/callback', 'Auth\GoogleSocialiteController@handleCallback');

Route::get('auth/facebook', 'Auth\FacebookSocialiteController@redirectToFacebook');
