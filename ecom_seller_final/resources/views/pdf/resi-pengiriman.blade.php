		...
		<div id="tb">
            <table class="table" width="50%" border="1" bordercolor="#000000" style="border-collapse: collapse;" cellpadding="2">
                <tr style="height: 90px">
                    <td style="text-align: center; vertical-align:middle" width='50%'><img src="https://SIMANHURAonline.com/front/assets/images/custom-image/logo_new.png" alt="" width="85%"></td>
