      ...
      <div class="container mt-5">
        <div class="page-error">
          <div class="page-inner">
            {{-- <h1>404</h1> --}}
            <img src="{{ asset('assets/img/error_401.png') }}" width="500" alt="404" style="margin-top: 40px;">
            <div class="page-description" style="margin-top: 20px; font-size: 30px;">
              No authorization found
            </div>
            <div class="page-description" style="font-size: 16px;">
              This page is not publically available. To access it please login with approved auth.
            </div>
