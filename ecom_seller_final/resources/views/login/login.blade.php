...
<head>
  ...
  <title>Login &mdash; ADMIN PANEL SIMANHURA</title>
  <link rel="icon" type="image/png" href="{{ asset('assets\img\custom-image\favicon-32x32.png') }}" sizes="32x32" />
  <link rel="icon" type="image/png" href="{{ asset('assets\img\custom-image\favicon-16x16.png') }}" sizes="16x16" />
  ...
  <div id="app">
    <section class="section">
       <div class="d-flex flex-wrap align-items-stretch">
          <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white" id="login_form">
             <div class="p-4 m-3">
                <img src="{{ asset('assets/img/custom-image/logo_new.png') }}" alt="logo" width="220" class="mb-4 mt-2">
                <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">SELLER PANEL SIMANHURA</span></h4>
                ...
                <div class="text-center text-small" style="margin-top: 46%;">
                   Copyright &copy; SIMANHURA
                </div>
             </div>
          </div>

          <div class="col-lg-8 col-md-6 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" style="background-size: cover" id="login_image" data-background="{{ asset('assets/img/login.jpg') }}">
