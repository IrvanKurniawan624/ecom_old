		...
		<div class="container">
		  <div class="row">
			<div class="col-sm-12 text-center">
				<img class="img-404" width="30%" src="{{ asset('front/assets/images/custom-image/401.png') }}" alt="" />

				<h1 class="main-title text-center">401</h1>
				<h3 class="sub-title text-center">Unauthorized</h3>

				<p class="desc-content text-center">Anda tidak diperkenankan untuk mengakses halaman!</p>
