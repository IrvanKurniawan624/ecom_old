		...
		<div class="container">
		  <div class="row">
			<div class="col-sm-12 text-center">
				<img class="img-404" width="40%" src="{{ asset('front/assets/images/custom-image/sudah-bayar.png') }}" alt="" />

				<h1 class="main-title text-center">Payment Complete</h1>
				<h3 class="sub-title text-center">Anda sudah membayar</h3>

				<p class="desc-content text-center">Oops! Anda sudah melakukan pembayaran untuk transaksi ini</p>

				<a class="link-404" href="{{ url()->previous() }}">Kembali Yuk</a>
			</div>
		  </div>
		</div>
	</section>
