		...
		<div class="container">
		  <div class="row">
			<div class="col-sm-12 text-center">
				<img class="img-404" width="35%" src="{{ asset('front/assets/images/custom-image/checkout-gagal.png') }}" alt="" />

				<h1 class="main-title text-center">Yahh!</h1>
				<h3 class="sub-title text-center">Checkout gagal dilakukan</h3>

				<p class="desc-content text-center">Checkout tidak bisa dilakukan karena anda belum memilih produk</p>

				<a href="/"><button class="btn btn-danger">Belanja Yuk</button></a>
			</div>
		  </div>
		</div>
	</section>
