		...
		<div class="container">
		  <div class="row">
			<div class="col-sm-12 text-center">
				<img class="img-404" width="40%" src="{{ asset('front/assets/images/custom-image/delivery.png') }}" alt="" />

				<h1 class="main-title text-center">Track Order</h1>
				<h3 class="sub-title text-center">tidak ditemukan</h3>

				<p class="desc-content text-center">Data track order tidak ditemukan silahkan coba lagi nanti!</p>
