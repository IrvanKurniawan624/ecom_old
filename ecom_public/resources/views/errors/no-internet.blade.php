		...
		<div class="container">
		  <div class="row">
			<div class="col-sm-12 text-center">
				<img class="img-404" width="35%" src="{{ asset('front/assets/images/custom-image/no-internet.png') }}" alt="" />

				<h1 class="main-title text-center">Oops!</h1>
				<h3 class="sub-title text-center">Jaringan atau koneksi anda terputus</h3>

				<p class="desc-content text-center">Jaringan anda sedang error atau terputus dari internet</p>
				<a href="{{ url()->previous() }}"><button class="btn btn-danger">REFRESH</button></a>
			</div>
		  </div>
		</div>
	</section>
