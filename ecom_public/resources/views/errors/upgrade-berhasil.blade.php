		...
		<div class="container">
		  <div class="row">
			<div class="col-sm-12 text-center">
				<img class="img-404" width="35%" src="{{ asset('front/assets/images/custom-image/upgrade-berhasil.png') }}" alt="" />

				<h1 class="main-title text-center">Horray!</h1>
				<h3 class="sub-title text-center">Proses Upgrade Berhasil</h3>

				<p class="desc-content text-center">Proses upgrade berhasil dilakukan selanjutnya akan kami review dulu datamu. silahkan cek notifikasi dan email secara berkala</p>
